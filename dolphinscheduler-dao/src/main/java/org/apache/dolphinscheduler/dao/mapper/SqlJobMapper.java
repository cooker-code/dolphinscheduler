...
/**
 * Mapper interface for {@link SqlJob}.
 */
@Mapper
public interface SqlJobMapper extends BaseMapper<SqlJob> {

    /**
     * Query a SQL job by project code and job slug.
     *
     * @param projectCode project code
     * @param jobSlug     unique job slug within the project
     * @return SqlJob or null if not found
     */
